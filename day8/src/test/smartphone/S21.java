...
public class S21 implements SmartPhone {
	...
	public void sendSMS(String phoneNumber) {
		System.out.println(phoneNumber + "로 문자 메시지를 보낸다.");
	}

	@Override
	public void receiveSMS(String phoneNumber) {
		System.out.println(phoneNumber + "에서 온 문자 메시지를 받는다.");
	}
	...
	public void stopMusic() {
		System.out.println("실행 중인 음악을 중지합니다.");
	}

	@Override
	public void installApp(String appName) {
		System.out.println(appName + "앱을 인스톨 합니다.");
	}
